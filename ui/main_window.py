...
class MainWindow(QMainWindow):
    ...
    def _build_hero(self) -> QWidget:
        ...
        self._browse_btn.setAccessibleName("Import clips")
        ...
        self._hero_output_btn.setAccessibleName("Reveal latest export")
        ...
        self._export_thumbs_btn.setAccessibleName("Export thumbnails")
    ...
    def _build_queue_tab(self, *, compact: bool = False) -> QWidget:
        ...
        clear.setAccessibleName("Clear export queue")
    ...
    def _build_track_tab(self, *, compact: bool = False) -> QWidget:
        ...
        self._detect_btn.setAccessibleName("Find subjects")
        ...
        self._dryrun_btn.setAccessibleName("Show export plan")
    ...
    def _build_action_bar(self) -> QHBoxLayout:
        ...
        self._export_btn.setAccessibleName("Export current clip")
        ...
        self._export_all_btn.setAccessibleName("Export queued clips")
        ...
        self._cancel_btn.setAccessibleName("Stop active operation")
    ...
    def _build_export_workspace_panel(self) -> QWidget:
        ...
        self._open_output_btn.setAccessibleName("Reveal latest export in folder")
