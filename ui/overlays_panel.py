...
class OverlayRow(QFrame):
    ...
    def __init__(self, overlay: TextOverlay, *, max_seconds: float = 60.0, parent: QWidget | None = None) -> None:
        ...
        self._rm.setAccessibleName("Remove text overlay")
        ...
        self._position.setAccessibleName("Overlay position")
        ...
        self._size = QSpinBox()
        self._size.setAccessibleName("Overlay font size")
        ...
        self._color_btn.setAccessibleName("Choose overlay text color")
        ...
        self._start.setAccessibleName("Overlay start time")
        ...
        self._end.setAccessibleName("Overlay end time")
...
class OverlaysPanel(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self._presets_btn.setAccessibleName("Add overlay preset")
        ...
        self._add_btn.setAccessibleName("Add text overlay")
        ...
        for key in ("intro", "lower_third", "cta"):
            ...
            btn.setAccessibleName(f"Add {self._PRESET_LIBRARY[key][0].lower()} overlay")
